...
```bash
pip install 'agent-governance[claude-agent]'
```
...
from agent_governance.adapters.claude_agent import governance_hook_matchers
...
[`sdk/python/examples/claude_agent_quickstart.py`](https://github.com/getrubric/platform/blob/main/sdk/python/examples/claude_agent_quickstart.py) runs Claude Agent against an in-tree MCP server with governance installed end-to-end.
