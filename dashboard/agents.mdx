...
Agents are usually registered automatically — the SDK enrolls on first boot and Rubric creates the agent record idempotently. **You rarely need to register agents manually.**
