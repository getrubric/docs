...
<Note>
This page assumes you've already been onboarded onto Rubric and your operator gave you the API URL plus a dashboard URL. If you haven't installed the SDK yet, do [Installation](/guides/installation) first.
</Note>
